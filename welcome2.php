...
{ 
  ...
  if( isset($_POST["element_1"]) &&!empty($_POST["element_1"]))
  {
   $val = $_POST["element_1"];
	...
	case 3: header('Location:registerasadmin.php');break;
	case 4: header('Location:deleteaccount.php');break;
	case 5:header('Location:adminaddevent.php'); break;
...
<label class="choice" for="element_1_3">Add new account</label>
<input id="element_1_4" name="element_1" class="element radio" type="radio" value="4" />
<label class="choice" for="element_1_4">Delete account</label>
<input id="element_1_4" name="element_1" class="element radio" type="radio" value="5" />
<label class="choice" for="element_1_4">Add new event</label>
