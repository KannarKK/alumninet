...
{ 
  ...
  if( isset($_POST["element_1"]) &&!empty($_POST["element_1"]))
  {
   if($_POST["element_1"]==1)
	...
	if($_POST["element_1"]==3)
    header('Location:studyaddorupdate.php');
	if($_POST["element_1"]==4)
    header('Location:alumniupdate.php');
	if($_POST["element_1"]==5)
...
<label class="choice" for="element_1_1">Update/Add Work Experience</label>
<input id="element_1_2" name="element_1" class="element radio" type="radio" value="2" />
<label class="choice" for="element_1_2">Update Address</label>
<input id="element_1_3" name="element_1" class="element radio" type="radio" value="3" />
<label class="choice" for="element_1_3">Update/Add Higher Studies information</label>
<input id="element_1_4" name="element_1" class="element radio" type="radio" value="4" />
<label class="choice" for="element_1_4">Update general information</label>
<input id="element_1_4" name="element_1" class="element radio" type="radio" value="5" />
<label class="choice" for="element_1_4">Update other (password)</label>
