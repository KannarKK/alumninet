...
<form target="_blank" action="contactsearchprof1.php" method="POST">
...
<div id ="div1" class="form_container">
	...
	<input  name="CHname"  type="checkbox"  checked ="checked"  />Name<br>
	<input  name="CHDept"  type="checkbox"    checked ="checked"/>Department<br>
	<input  name="CHCAddr"  type="checkbox"   checked ="checked" />Current Address<br>
	<input  name="CHPAddr"  type="checkbox"   checked ="checked" />Permanenent Address<br>
