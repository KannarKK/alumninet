...
{ 
  ...
  if( isset($_POST["element_1"]) &&!empty($_POST["element_1"]))
  {
	...
	case 2: header('Location:alumupdateoptions.php');break;
	case 3: header('Location:contactus.php');break;
	case 4: header('Location:contactus.php');break;break;
...
<label class="choice" for="element_1_3">Ask to delete account</label>
